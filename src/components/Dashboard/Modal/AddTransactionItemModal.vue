    ...
    <div v-if="modelValue"
        ...
        <div v-else ref="modalContainer"
            ...
            <h3 class="text-3xl font-semibold mb-4">
                Add {{item.supply_name || item.equipment_name}}   
            </h3>

            <!-- FOR THE OFFICE SUPPLY -->
            <div v-if="props.item.type === 'Office Supply'" class="px-5 text-start max-h-[69vh] overflow-y-auto">
                <!-- QUANTITY -->
                <label class="block mt-4 mb-2 text font-medium text-gray-900 dark:text-gray-200">Quantity to Borrow:</label>
            ...
            <!-- FOR THE EQUIPMENT -->
            <div v-if="props.item.type === 'Office Equipment'" class="px-5 text-start max-h-[69vh] overflow-y-auto">
                <!-- SELECTION OF EQUIPMENT COPY -->
                <label class="block mt-4 mb-2 text font-medium text-gray-900 dark:text-gray-200">Select Copy to Add:</label>
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="(copy, index) in props.equipmentCopies" :key="index">
                            <td></td>
                            <td>Copy {{ index + 1 }}</td>
