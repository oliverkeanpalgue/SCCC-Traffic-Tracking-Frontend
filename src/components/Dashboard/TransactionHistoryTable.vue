                ...
                >
                  ...
                  <td>
                    <ul v-if="transaction.borrow_transaction_items.length">
                      <li
                        v-for="item in transaction.borrow_transaction_items"
                        :key="item.id"
                      ...
                      >
                        ...
                        <span
                          v-if="item.item_type === 'Office Supply'"
                          class="col-span-2"
                        >
                          {{
                            officeSupplies.find(
                        ...
                        <span
                          v-if="item.item_type === 'Equipment Copy'"
                          class="col-span-2"
                        >
                          {{
                    ...
                    <span
                      v-else
                      class="flex flex-row justify-start items-center text-yellow-600"
                    >
