...
const OpenAddOfficeModal = () => {
    isOpenAddOfficeModal.value = true;
        ...
        <html>
            ...
            <body>
                ...
                <div class="print-footer">
                    <p>Total Categories: ${filteredOffices.value.length}</p>
                </div>
            </body>
        </html>
    `);
        ...
        <div v-else class="overflow-x-auto">
            ...
            <div class="rounded-lg min-h-110 dark:bg-gray-900">
                <table class="w-full text-sm text-center text-gray-500 dark:text-gray-400">
                    <thead class=" dark:bg-gray-600 dark:text-gray-300">
                        <tr class="bg-gray-700 text-gray-200 uppercase text-center text-xs rounded-lg">
                            ...
                            <th class="py-3" @click="sortByField('office_name')">
                                Office Name
               ...
               text-gray-700 dark:text-gray-200 transition duration-150 ease-in-out">
                                    ...
                                    <span>
                                        {{
                                            (databaseStore.officeEquipments.filter(e => e.office_id ===
                                                office.id)?.length || 0) +
                                            (databaseStore.officeSupplies.filter(s => s.office_id === office.id)?.length
                                                || 0)
                                        }}
                                    </span>
