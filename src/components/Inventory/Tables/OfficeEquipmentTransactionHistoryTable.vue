...
// Modify the filteredTransactionItems computed property
...
<template>
    <div class="overflow-x-auto">
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <!-- FILTER OFFICES BUTTON -->
            <div class="relative ml-2 flex justify-end w-full md:w-1/5">
                <button @click="toggleOfficeFilter" ref="officeButtonRef"
                    class="flex items-center rounded-lg px-6 py-2 text-base font-medium border dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600">
