    ...
    <div class="flex flex-col sm:flex-row items-center gap-8 z-10">
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg max-w-lg">
        ...
        <form @submit.prevent="submit" class="flex grid grid-cols-3 gap-4">
          ...
          <button type="submit" class=" col-span-3 bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700">Sign
            Up</button>

          <div>
            <button type="submit" class="col-span-3 bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700">
              Sign Up
            </button>
          </div>
        </form>
